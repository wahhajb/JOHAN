let handler = m => m; 
 ...
 let responses; 
 if (/^ايانوكوجي بحبك|ايانوكوجي عاوزه اتجوزك|بحبك|بموت فيك|نتجوز|ايانوكوجي هنتجوز امتي|ايانوكوجي انت ليا|ايانوكوجي بموت فيك$/i.test(m.text)) { 
 responses = [ 
 'شكرا  ',
   'ونا بكرهك',
 'هفكر في الموضوع',  
 ...
 }else if (/^ ايانوكوجي عامل ايه|عامله ايه|عاملين ايه|كيفكم|عاملين ايه يشبب$/i.test(m.text)) { 
 responses = [ 
