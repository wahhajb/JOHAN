...
if (!text) throw `*[❗] نسيت التقرير - البلاغ*\n\n*مثال:*\n*${usedPrefix + command} الامر ${usedPrefix}شادو عمكم*`
...
let teks = `*❒═════[ تحذير ]═════❒*\n*┬*\n*├❧ الرقم:* wa.me/201063720595${m.sender.split`@`[0]}\n*┴*\n*┬*\n*├❧ رسالة:* ${text}\n*┴*`
conn.reply('wa.me/201112422078', m.quoted ? teks + m.quoted.text : teks, null, {
contextInfo: {
